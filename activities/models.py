...
# Meta data
    astro_category = ParentalManyToManyField(Category, blank=True, verbose_name='Old Scientific Categories', limit_choices_to=limit_lang_choice)
    category = ParentalManyToManyField(SciCategory, blank=True, verbose_name='New Scientific Categories',limit_choices_to=limit_lang_choice)

    age = ParentalManyToManyField('activities.Age',blank=True,limit_choices_to=limit_lang_choice)
    level = ParentalManyToManyField(Level, help_text='Specify at least one of "Age" and "Level". ', verbose_name='Education level', blank=True, limit_choices_to=limit_lang_choice)
    time = models.ForeignKey(Time, on_delete=models.SET_NULL, blank=True, null=True,limit_choices_to=limit_lang_choice)
    group = models.ForeignKey(Group, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='Group or individual activity',limit_choices_to=limit_lang_choice)
    supervised = models.ForeignKey(Supervised, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='Supervised for safety',limit_choices_to=limit_lang_choice)
    cost = models.ForeignKey(Cost, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='Cost per student',limit_choices_to=limit_lang_choice)
    location = models.ForeignKey(Location, on_delete=models.SET_NULL, blank=True, null=True,limit_choices_to=limit_lang_choice)
    skills = ParentalManyToManyField(Skills, blank=True, verbose_name='core skills', limit_choices_to=limit_lang_choice)
    learning = ParentalManyToManyField(Learning, blank=True, verbose_name='type of learning activity', help_text='Enquiry-based learning model', limit_choices_to=limit_lang_choice)
